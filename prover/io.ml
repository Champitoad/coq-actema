...
(* -------------------------------------------------------------------- *)
let parserfun_type = MenhirLib.Convert.Simplified.traditional2revised P.xtype

(* -------------------------------------------------------------------- *)
let parserfun_expr = MenhirLib.Convert.Simplified.traditional2revised P.xexpr

(* -------------------------------------------------------------------- *)
let parserfun_nexpr = MenhirLib.Convert.Simplified.traditional2revised P.xnexpr

(* -------------------------------------------------------------------- *)
let parserfun_form = MenhirLib.Convert.Simplified.traditional2revised P.xform

(* -------------------------------------------------------------------- *)
let parserfun_goal = MenhirLib.Convert.Simplified.traditional2revised P.xgoal

(* -------------------------------------------------------------------- *)
type reader = Lexing.lexbuf Disposable.t

let lexbuf (reader : reader) = Disposable.get reader
...
(* -------------------------------------------------------------------- *)
let from_string data = Disposable.create (Lexing.from_string data)

(* -------------------------------------------------------------------- *)
let finalize (reader : reader) = Disposable.dispose reader
