...
Notation lsar := (@cons Type nat (@cons Type bool (cons ( Prop) nil))).
...
intro h.
back h (cons false nil)(@nil bool)(cons false nil)(cons ip0 nil).
Abort.
