...
let predefined =
  ...
  ; (Constants.and_, Env.{ symbol = "∧"; implicit_args = []; position = Infix })
  ...
  ; (Constants.eq, Env.{ symbol = "="; implicit_args = [ 0 ]; position = Infix })
  ; (Constants.equiv, Env.{ symbol = "↔"; implicit_args = []; position = Infix })
  ]
